...
if(isset($_POST["giris"])) {
	...
	$sonuc = $sorgu->fetch(); // kayıtı alıyoruz
	...
	if($sonuc) {
		...
		// echo "Tur = " . $sonuc["tur"] . " Ad = " . $sonuc["ad"];
		if($sonuc["tur"] == 'admin') {
            echo "<script>alert('ADMIN olarak giriş başarılı')</script>";
			$_SESSION["admin"] = "evet";
		} else {
            echo "<script>alert('ÜYE olarak giriş başarılı')</script>";
